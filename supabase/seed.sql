...
values
  ...
  ('everything-everywhere',
   ...
   'The fate of the multiverse rests on the shoulders of a middle-aged Chinese laundromat owner.',
   2022, 139,
   array['Sci-Fi', 'Action', 'Comedy'],
   ...
   'https://image.tmdb.org/t/p/original/feSiISwgEpVzR1v3zv2n2NSa0aZ.jpg',
   8.0, 3971, false),
  ...
  ('dune-2021',
   ...
   'https://image.tmdb.org/t/p/w500/d5NXSklXo0qyIYkgV61Q0SIH5fD.jpg',
  ...
  ('blade-runner-2049',
   ...
   'https://image.tmdb.org/t/p/original/ilRyazdMlwGFGo7JoerXqF6QLCR.jpg',
   8.0, 2910, false)
...
values
  ...
  ('rev-008', 'everything-everywhere', 'Lily Chen',
   'The most human movie about the multiverse',
   'Underneath all the googly eyes and absurdist humor is a film about generational trauma, immigrant identity, and the radical act of choosing love over nihilism. Ke Huy Quan''s comeback is one for the books.',
   5.0, false),
  ...
  ('rev-010', 'dune-2021', 'Fatima A.',
   'The sci-fi epic we''ve been waiting decades for',
   'Villeneuve makes the desert feel genuinely alien and dangerous. The sound design alone justifies a cinema viewing. My only gripe is that it ends at the midpoint of the story — but Part Two more than delivers.',
   4.6, false),
